...
\ytvideo{Performance-Marketing als messbarer Vertriebshebel}{https://youtu.be/756dea00Wmg}
...
\ytvideo{Landing Page Optimierung: Conversion-Hebel in der Praxis}{https://youtu.be/ZOE-CCudzZM}

\begin{loesungbox}
\begin{center}
\begin{tikzpicture}[font=\sffamily\footnotesize]
  % 5-Stufen-Funnel als Trapez-Stack
  % Breiten oben (b1) -> unten (b5)
  \def\xc{0}
  \def\stages{{
    {6.0, "Anzeige (LinkedIn / Google)", "Reichweite"},
    {5.0, "Landing Page + Energie-Rechner", "Klicks"},
    {3.7, "Whitepaper / Termin-Anfrage", "Leads"},
    {2.6, "Innendienst-Kontakt < 24\\,h", "MQL"},
    {1.6, "Beratungstermin (Vor-Ort / Video)", "SQL / Ziel: 80"}
  }}
  % Vier Trapeze (mit jeweiliger Top/Bottom-Breite)
  \def\h{0.85}
  \def\ystart{4.25}
  % Layer 1
  \foreach \i/\wtop/\wbot/\label/\kpi/\colmix in {%
    0/6.0/5.0/{Anzeige (LinkedIn / Google)}/{Reichweite}/30,
    1/5.0/3.7/{Landing Page + Energie-Rechner}/{Klicks}/50,
    2/3.7/2.6/{Whitepaper / Termin-Anfrage}/{Leads}/65,
    3/2.6/1.6/{Innendienst-Kontakt $<$ 24\,h}/{MQL}/80,
    4/1.6/1.0/{Beratungstermin}/{SQL: Ziel 80}/100} {
    ...
    \fill[lpAccent!\colmix!lpAccentLight, draw=lpAccent, line width=0.6pt]
      (\wtl,\y) -- (\wtr,\y) -- (\wbr,\yb) -- (\wbl,\yb) -- cycle;
    \pgfmathparse{\colmix > 55 ? "white" : "lpInk"}
    \node[font=\sffamily\bfseries\footnotesize, color=\pgfmathresult, align=center]
      at (0, \y-\h/2+0.05) {\label};
    \node[anchor=west, font=\sffamily\scriptsize\itshape, color=lpGray]
      at (3.6, \y-\h/2+0.05) {\kpi};
  }
  % Ziel-Marker
  \node[anchor=west, font=\sffamily\bfseries\scriptsize, color=lpAmberBorder]
    at (3.6, -0.1) {\textrightarrow{} ca.\ 20 Auftr{\"a}ge};
\end{tikzpicture}
\end{center}
...
\ytvideo{AIDA-Formel: vom Klick zum Abschluss}{https://studyflix.de/wirtschaft/aida-formel-1174}
...
\ytvideo{KPI \& Kennzahlen: Key Performance Indicators}{https://studyflix.de/jobs/karriere-tipps/kpi-6551}
