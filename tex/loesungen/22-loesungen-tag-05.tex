...
\ytvideo{Customer Journey — die fünf Phasen verstehen}{https://youtu.be/3XtfQvI4hzI}
...
\ytvideo{SEO als Grundlage digitaler Sichtbarkeit}{https://youtu.be/EFIRV4MwrcE}
...
\end{document}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               schützt langfristige Marge \textendash{} auch wenn das Quartalsreporting kurzfristig anders aussieht.
\end{merkbox}
\end{loesungbox}
