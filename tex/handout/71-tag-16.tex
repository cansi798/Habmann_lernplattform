...
Für Unternehmen bedeutet das: bestimmte Kennzahlen (Anteil ``Taxonomie-fähiger'' Umsätze, CapEx (\emph{Capital Expenditure}, Investitionsausgaben), OpEx (\emph{Operating Expenditure}, Betriebsausgaben)) müssen offengelegt werden. Das setzt eine systematische Erfassung der Aktivitäten und ihrer Klassifikation voraus.
...
\begin{itemize}
  \item \textbf{Impact Materiality} (Auswirkungs-Wesentlichkeit)\textbf{.} Wie wirkt unser Unternehmen auf Umwelt und Gesellschaft?
...
\begin{enumerate}
  \item \fachbegriff{Plan.} KPI-Dictionary aktualisieren, Datenanforderungen an Owner kommunizieren, Cadence (Berichtstakt) festlegen.
  ...
  \item \fachbegriff{Assure} (d.\,h.\ externe Prüfung absichern)\textbf{.} Interne und externe Assurance (Limited / Reasonable). Sampling (Stichprobenprüfung), Walkthroughs, Findings (Prüfungsbeanstandungen).
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Reconciliation} (Abgleich) \textbf{zu Finance.} ESG-Kennzahlen mit Bezug zu Finanzdaten (z.\,B.\ Umsatz-Anteile) müssen abgleichbar sein.
...
Im \emph{Dry Run} (Probelauf) ist es legitim, eine reduzierte Control-Menge zu fahren -- mit dokumentierter Begründung und Verbesserungsplan. Welche Controls bleiben Pflicht:
...
\begin{itemize}
  \item Welche 3 Entscheidungen sind nicht delegierbar (Risk Appetite (Risikobereitschaft), Systemgrenzen, Transparenzregeln)?
