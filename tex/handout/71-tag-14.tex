...
\begin{itemize}
  \item Antwortzeit $\leq$ 300\,ms (P99).
  \item Payload $\leq$ 200\,KB pro Response.
...
\begin{itemize}
  ...
  \item \fachbegriff{Procurement} (für Rücknahme-Verträge).
...
CO\textsubscript{2}-Reporting & Veröffentlicht der Vendor Scope-1/2/3-Emissionen? \\
...
\begin{itemize}
  \item Performance Budget Antwortzeit (P99 $\leq$ 500\,ms).
