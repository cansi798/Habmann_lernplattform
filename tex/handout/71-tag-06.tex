...
\begin{itemize}
  \item BPMS-Kernbausteine kennen: Prozessengine, Aufgaben-/Worklist, Forms, Regelwerk, Monitoring, Audit Trail, Versionierung.
  \item API-Verträge benennen: Endpoint, Input/Output, Fehlercodes, Auth, Rate Limits, Versionierung, Idempotenz.
...
\begin{itemize}
  \item Einen BPMS-Blueprint für einen E2E-Prozess (Rollen, Tasks, SLAs, Eskalation, Audit Trail) entwerfen.
...
\begin{itemize}
  ...
  \item \textbf{XOR Gateway ``Klärung nötig?''} \\
...
\subsubsection{MVP-Entscheidung}
