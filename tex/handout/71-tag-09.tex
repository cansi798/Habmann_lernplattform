...
\begin{itemize}
  ...
  \item Kanban-Prinzipien einordnen: Visualisieren, WIP-Limits (Work in Progress -- Menge der gleichzeitig in Bearbeitung befindlichen Arbeitspakete), Pull-System, Flow-Metriken.
  \item CI-Pipeline (Continuous Integration -- Codeänderungen werden regelmäßig automatisch getestet und integriert) und ihre typischen Stufen kennen: Build, Tests, Security/Quality Checks, Deploy.
...
\begin{itemize}
  \item DORA-Metriken (DevOps Research and Assessment -- vier Liefer-Kennzahlen; Lead Time, Deployment Frequency, Change Failure Rate, MTTR = Mean Time to Restore) als Steuerungssprache nutzen.
...
\begin{itemize}
  ...
  \item \fachbegriff{Kanban-Wildwuchs.} Boards mit 30 Tickets in ``In Progress''; WIP-Limits nicht durchgesetzt; Pull-System (d.h. Team zieht Aufgaben erst bei freier Kapazität) nur auf dem Papier.
...
\subsubsection{MVP -- Minimum Viable Product (Woche 1--4)}
...
\begin{itemize}
  ...
  \item SLA-Reminder (Service Level Agreement -- vereinbarte Qualitätsstandards) und Eskalation bei Fristüberschreitung.
  \item Audit Trail.
...
\begin{itemize}
  ...
  \item Prozess-KPIs (Key Performance Indicators -- Messgrößen für Ziel-Steuerung) für Steuerung.
\end{itemize}
