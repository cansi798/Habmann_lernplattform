...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 9 \textendash{} \emph{Agile Delivery als Steuerungssystem}: Scrum, Kanban, CI-Pipelines und Infrastructure as Code. Die Aufgaben gliedern sich in drei Niveaus:
...
\begin{description}[style=nextline,leftmargin=18pt,labelindent=0pt,itemsep=8pt]
  ...
  \item[3.~Infrastructure as Code — Reproduzierbarkeit und Auditierbarkeit] \href{https://youtu.be/3gZ_-k9t-KQ}{\textcolor{lpAccent}{https://youtu.be/3gZ_-k9t-KQ}}\\[2pt]
...
\begin{enumerate}
  ...
  \item \textbf{Entscheidung unter Unsicherheit:} Wo akzeptieren Sie bewusst \emph{Risiko} im MVP (z.\,B.\ weniger Tests) \textendash{} und wie begrenzen Sie den Schaden (Rollback, Canary, Feature Toggle)?
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Senior-KPI-Set:} Welche \emph{zwei} der vier f\"uhren Sie als Executive-KPIs \textendash{} und warum lassen Sie die anderen zwei intern?
