...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 8 \textendash{} \emph{Vom Ist verstehen zum Zukunft steuern}: Process Enhancement, Predictive Analytics, Real-time Monitoring, DWH (\emph{Data Warehouse} -- zentrales Datenlager, das Daten aus verschiedenen Quellen f\"ur Analysen konsolidiert)/ETL (\emph{Extract, Transform, Load} -- Prozess zur Datenintegration: Extraktion, Umwandlung und Laden in ein Zielsystem) und BI-Dashboards (\emph{Business Intelligence} -- Technologien und Methoden zur Analyse und Aufbereitung von Unternehmensdaten). Heute schlie{\ss}en sich die Themen von Tag 7 (Discovery + Conformance) um die Predictive-Schicht: \emph{wir bewegen uns vom ``Was war?'' zum ``Was kommt?''}. Die Aufgaben gliedern sich in drei Niveaus:

\begin{itemize}
  \item \nivLi{} \textendash{} \fachbegriff{Wissen.} ML-Typen (\emph{Machine Learning} -- Teilgebiet der KI: Systeme erkennen Muster in Daten und lernen daraus), ETL-Schritte, Dashboard-Prinzipien. 5\,--\,10 Minuten.
...
\begin{description}[style=nextline,leftmargin=18pt,labelindent=0pt,itemsep=8pt]
  ...
  \item[2.~Datenbank vs. Data Lake vs. Data Warehouse — die Unterschiede] \href{https://youtu.be/BQuyIwi_RCQ}{\textcolor{lpAccent}{\nolinkurl{https://youtu.be/BQuyIwi_RCQ}}}\\[2pt]
...
\ytvideo{ETL (Extract Transform Load) für Data Warehousing einfach erklärt}{https://youtu.be/VVJRBhUkX5o}
...
\begin{enumerate}
  \item \emph{Quelle} (CRM = \emph{Customer Relationship Management}, systematische Gestaltung aller Kundenbeziehungen; ERP = \emph{Enterprise Resource Planning}, integriertes Softwaresystem zur unternehmensweiten Ressourcenplanung; Tickets, Logs).
...
\begin{enumerate}
  \item F\"ullen Sie den Canvas f\"ur \emph{Use Case A: ``SLA-Risiko fr\"uh erkennen''} (\emph{SLA} = \emph{Service Level Agreement}, vertraglich vereinbarte Qualit\"ats- und Leistungsstandards f\"ur Dienstleistungen).
...
\ytvideo{Data Lake vs. Data Warehouse — was ist der Unterschied?}{https://studyflix.de/informatik/data-lake-4364/video}
...
\ytvideo{Data Warehouse einfach erklärt — Grundlagen}{https://youtu.be/EHmeK1nMBvA}
...
\begin{enumerate}
  ...
  \item \textbf{MVP-Entscheidung} (\emph{Minimum Viable Product} -- erste marktreife Produktversion mit minimalem Funktionsumfang)\textbf{:} Welche \emph{2 Features} und welche \emph{1 Datenquelle} lassen Sie zuerst weg \textendash{} und wie kompensieren Sie?
\end{enumerate}
...
\ytvideo{Business Intelligence KPI Dashboard in Power BI}{https://youtu.be/0BwQvLGUbZg}
