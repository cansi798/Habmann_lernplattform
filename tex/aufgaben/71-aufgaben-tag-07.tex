...
\begin{itemize}
  ...
  \item \nivLii{} \textendash{} \fachbegriff{Anwendung.} Happy Path (idealer Standardablauf) ableiten, Abweichungen klassifizieren, Guardrails. 15\,--\,30 Minuten.
...
\ytvideo{Introduction to Process Mining — 360°-Überblick (Wil van der Aalst)}{https://youtu.be/aHbHQ6caJoU}
...
\ytvideo{Celonis Conformance Checker — Tutorial}{https://youtu.be/QBvjRcqsySw}
...
\begin{enumerate}
  ...
  \item Definieren Sie \emph{drei Guardrails}: (a) Sichtbarkeit (Pflichtkennzeichen ``EXCEPTION''), (b) SLA (\emph{Service Level Agreement}, vertraglich vereinbarte Qualit\"ats- und Leistungsstandards f\"ur Dienstleistungen) f\"ur Nachbuchung, (c) Monitoring + Owner.
...
\ytvideo{Process Discovery — RWTH Lecture (van der Aalst)}{https://youtu.be/jPERVdZYgA8}
...
\smallskip
\textbf{Restriktionen:} \textbf{6 Wochen} bis Audit; Budget \textbf{70\,k\,\euro}; Logs unvollst\"andig (nur ERP -- \emph{Enterprise Resource Planning}, integriertes Softwaresystem zur unternehmensweiten Ressourcenplanung; + E-Mail-Tickets); Zielkonflikt Speed vs.\ Compliance.
...
\ytvideo{Celonis in der Produktion — Process Mining im Einsatz}{https://youtu.be/RERGYW5o5xY}
