...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 11 \textendash{} \emph{RPA als Steuerungs- und Risikohebel}: Plattform\"uberblick (Studio/Orchestrator), Eignung von Use Cases, Attended vs.\ Unattended, Nutzen-/Risikoabw\"agung und das richtige Stufenmodell. Die Aufgaben sind in drei Niveaus gegliedert:

\begin{itemize}
  \item \nivLi{} \textendash{} \fachbegriff{Wissen.} Eignungs-Kriterien, Plattform-Begriffe, Nutzen-/Risiko-Landkarte. 5\,--\,10 Minuten.
  \item \nivLii{} \textendash{} \fachbegriff{Anwendung.} Use-Case-Scoping, Stufenmodell, Bot-Flow, KPIs. 15\,--\,30 Minuten.
...
\begin{enumerate}
  \item Nennen Sie \textbf{f\"unf Eignungskriterien} f\"ur einen typischen RPA-Use-Case (z.\,B.\ regelbasiert, stabile UI, klarer Input/Output, hohes Volumen, geringe Ausnahmenrate).
...
\textbf{A.} Rechnungsdaten aus E-Mail lesen \textrightarrow{} ERP erfassen \textrightarrow{} Status per Mail zur\"uckmelden.
...
\textbf{B \textendash{} Portal-Abh\"angigkeit:} Der Bot ruft ein Lieferanten-Portal ohne SLA an. Das Portal ist 1\,--\,2$\times$ pro Woche f\"ur 20 Minuten weg.\\[2pt]
...
\begin{enumerate}
  \item \textbf{Automation Funnel:} Definieren Sie f\"unf Stufen (Idea \textrightarrow{} Eignung \textrightarrow{} PoC \textrightarrow{} Pilot \textrightarrow{} Betrieb). Pro Stufe: \emph{Zugangskriterium} und \emph{Owner}.
