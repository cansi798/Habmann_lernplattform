...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 6 \textendash{} \emph{Von der Prozesslandkarte zur integrierten Ausf\"uhrung}: BPMS (\emph{Business Process Management System}, Softwareplattform zur Modellierung, Ausf\"uhrung und \"Uberwachung von Gesch\"aftsprozessen), APIs (\emph{Application Programming Interface}, standardisierte Schnittstelle zur Kommunikation zwischen Softwaresystemen), Cloud-native Skalierung und E2E-Methodenintegration. Das Heft baut auf den Repository- und Execution-Themen von Tag 4 auf und erweitert sie um Integration, Plattform-Skalierung und Operating-Model-Fragen. Die Aufgaben gliedern sich in drei Niveaus:
...
\emph{``Customer Complaint Handling''}: Reklamation kommt rein \textrightarrow{} Klassifizieren \textrightarrow{} ggf.\ R\"uckfrage \textrightarrow{} Entscheidung Kulanz/Retoure \textrightarrow{} Abwicklung \textrightarrow{} Abschluss \textrightarrow{} Reporting. SLAs (\emph{Service Level Agreement}, vertraglich vereinbarte Qualit\"ats- und Leistungsstandards f\"ur Dienstleistungen): 48\,h Erstreaktion, 10\,Tage Abschluss. Daten in CRM, ERP, E-Mail.
\end{infobox}
...
\begin{enumerate}
  ...
  \item \textbf{MVP-Entscheidung} (\emph{Minimum Viable Product}, erste marktreife Produktversion mit minimalem Funktionsumfang; Release 1 in 9 Wochen): was ist drin, was \emph{explizit nicht}?
\end{enumerate}
