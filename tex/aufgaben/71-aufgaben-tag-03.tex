...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 3 \textendash{} \emph{Vom Prozessbild zur Steuerung}: Stakeholder-Analyse, KPI-Steckbriefe (KPI = \emph{Key Performance Indicator}, Steuerungs-Kennzahl), SOA-Servicegrenzen (SOA = \emph{Service-Oriented Architecture}, dienstorientierte Architektur) und Workflow-Orchestrierung. Die Aufgaben sind in drei Niveaus gegliedert:
...
\ytvideo{Stakeholderanalyse — Definition und Durchführung}{https://studyflix.de/wirtschaft/stakeholderanalyse-6474/video}
...
\ytvideo{KPI — Key Performance Indicators einfach erklärt}{https://studyflix.de/jobs/karriere-tipps/kpi-6551/video}
...
F\"ur den Prozess \emph{``Idee \textrightarrow{} Prototyp \textrightarrow{} Freigabe''} soll ein \fachbegriff{Workflow} entworfen werden \textendash{} ausf\"uhrbar in einem Workflow-System mit \emph{Aufgaben}, \emph{Regeln}, \emph{Rollen}, \emph{Eskalationen}, \emph{SLAs} (Service Level Agreements -- vertraglich vereinbarte Bearbeitungs-/Reaktionszeiten), \emph{Audit Trail} und \emph{Monitoring}.
\end{infobox}
...
\ytvideo{Service-Oriented Architecture (SOA) verstehen}{https://youtu.be/JynwX6F7BCw}
...
\ytvideo{Workflow Management — Prozesse aktiv steuern}{https://youtu.be/3exCOwlNBIk}
