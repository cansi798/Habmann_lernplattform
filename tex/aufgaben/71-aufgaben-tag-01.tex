...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 1 \textendash{} \emph{BPMN 2.0 \& EPC} (BPMN = \emph{Business Process Model and Notation}; EPC = \emph{Ereignisgesteuerte Prozesskette}): Notation, Modellierungs-Grundlagen, Modellqualit\"at (GoM) und Zweckorientierung. Die Aufgaben sind in drei Niveaus gegliedert:
...
\ytvideo{Was ist ein Geschäftsprozess — und warum überhaupt modellieren?}{https://youtu.be/E5ZgMT7ty6E}
...
\ytvideo{Wofür modellieren wir? Die vier Zwecke und ihre Folgen}{https://youtu.be/xmls25KO7V8}
...
\begin{itemize}
  ...
  \item \textbf{Mindestens einen XOR-Konnektor} (XOR = \emph{exklusives Oder}; genau ein Pfad wird gew\"ahlt) f\"ur die Entscheidung \emph{vollst\"andig / unvollst\"andig} und/oder \emph{freigegeben / abgelehnt}.
...
\ytvideo{Pools und Lanes — wer macht was, und warum das strategisch wichtig ist}{https://youtu.be/AmEX0CxmzAs}
...
\begin{enumerate}
  ...
  \item \textbf{Verantwortungsmodell:} Wer ist verantwortlich? Skizzieren Sie eine \textbf{RACI-Aufteilung} (RACI = \emph{Responsible, Accountable, Consulted, Informed} -- Verantwortungsmatrix) f\"ur die Rollen \emph{Process Owner}, \emph{Modeler}, \emph{Reviewer}, \emph{Approver}, \emph{Fachbereich}.
...
\ytvideo{Prozessmanagement — Rollen, Verantwortung und Governance}{https://studyflix.de/wirtschaft/prozessmanagement-4973/video}
