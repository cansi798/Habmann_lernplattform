...
\ytvideo{CSRD, ESRS und EU-Taxonomie — wie hängt das alles zusammen?}{https://youtu.be/_ypAyhFA3MQ}
...
\ytvideo{ESG, CSRD und EU-Richtlinien für Unternehmen}{https://youtu.be/vZ-kc1M0oSk}
...
\begin{enumerate}
  \item Definieren Sie \textbf{acht Controls} entlang des Reportingprozesses: Pflichtfelder/Completeness; Plausibilit\"atsgrenzen (Schwellen); 2-Augen-Freigabe; \"Anderungslog (wer/was/warum); Zugriffskontrolle; Ausnahmegenehmigung; Reconciliation (Abgleich) zu Finance-Daten; Sampling-Review (Stichprobenprüfung) f\"ur Audit-Readiness (Prüfungsbereitschaft). Pro Control: \emph{Eingangskriterium}, \emph{Ausl\"oser}, \emph{Owner}, \emph{Eskalation bei Fehler}.
...
% --- AUFGABE 9 -----------------------------------------------------------
\aufgabenkopf{9}{Risk Appetite (Risikobereitschaft) \& Vorstands-Transparenzregeln}{\nivLiii}{35\,min}

\begin{infobox}[Rolle: CSO (Chief Sustainability Officer) / CFO / CIO gemeinsam]
...
% --- AUFGABE 10 ----------------------------------------------------------
\aufgabenkopf{10}{Minimum Viable Controls (MVC) f\"ur Dry Run (Probelauf)}{\nivLiii}{30\,min}
