...
\begin{itemize}
  ...
  \item \nivLii{} \textendash{} \fachbegriff{Anwendung.} Modelling Charter, Capability Map, MDA-Pfad, Naming-Audit, KPI-Set (\emph{KPI} = \emph{Key Performance Indicator}, Messgr\"o\ss e zur \"Uberwachung und Steuerung unternehmerischer Ziele). 15\,--\,30 Minuten.
...
\ytvideo{TOGAF in 12 Minuten — Enterprise Architecture in der Übersicht}{https://youtu.be/kp0yhrTKgg4}
...
\ytvideo{ArchiMate — Notation für Enterprise Architecture}{https://youtu.be/XGqbdfyuoaQ}
...
\begin{enumerate}
  ...
  \item \textbf{PSM:} Skizzieren Sie die konkrete Umsetzung: Welche bestehende Plattform (IAM = \emph{Identity \& Access Management}, System zur Verwaltung von Identit\"aten und Zugriffsrechten; Workflow-Engine), welche Schnittstellen, welche Audit-Logging-Pflicht?
...
\ytvideo{Business Capability Mapping — was sind Capabilities?}{https://youtu.be/_cC76sI8QrM}
...
\ytvideo{Zachman Framework in 9 Minuten — EA-Matrix demystifiziert}{https://youtu.be/zrA9Tia8k1Y}
