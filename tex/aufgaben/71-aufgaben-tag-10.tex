...
\noindent Dieses Aufgabenheft enth\"alt elf Aufgaben zu Tag 10 \textendash{} \emph{Skalierbare digitale Prozessarchitektur}: Microservices (kleine eigenst\"andige Dienste), Container/Kubernetes (Verpackungs- und Orchestrierungs-Plattform), TDD (Test-Driven Development -- Tests vor Code) und Teststrategien sowie DevOps-Strategien (Development + Operations als ein System) inklusive Operating Model. Die Aufgaben sind in drei Niveaus gegliedert:

\begin{itemize}
  \item \nivLi{} \textendash{} \fachbegriff{Wissen.} Begriffe, Servicegrenzen, Pipeline-Logik, Testpyramide. 5\,--\,10 Minuten pro Aufgabe.
  \item \nivLii{} \textendash{} \fachbegriff{Anwendung.} Servicegrenzen ziehen, Betriebskonzept entwerfen, SLOs (Service Level Objectives -- messbare Service-Ziele) definieren, RACI (Responsible, Accountable, Consulted, Informed -- Verantwortungs-Matrix) bauen. 15\,--\,30 Minuten.
...
\ytvideo{Microservices — warum, wann und mit welchen Grenzen}{https://youtu.be/ZXfLy229GLs}
...
\ytvideo{Kubernetes — Container-Orchestrierung in der Praxis}{https://youtu.be/SFVg7fDdvLE}
...
\begin{enumerate}
  ...
  \item Definieren Sie \textbf{zwei Betriebskennzahlen} (SLO-orientiert), z.\,B.\ \emph{Verf\"ugbarkeit}, \emph{Fehlerquote}, \emph{Latenz}, \emph{MTTR} (Mean Time to Recover -- mittlere Wieder\-herstellungs-Zeit) \textendash{} jeweils mit \emph{Owner} und \emph{Zielwert}.
  \item Entscheidung unter Unsicherheit: Wo akzeptieren Sie im \textbf{MVP} (Minimum Viable Product -- erste marktreife Version) bewusst Rest-Risiko (z.\,B.\ weniger E2E-Tests = End-to-End-Tests, also volle Durchl\"aufe)? Wie kompensieren Sie es (Canary, Feature Toggle, manuelle Kontrolle)? Dokumentieren Sie das in einem kurzen \emph{Risikoplan}.
\end{enumerate}
...
\ytvideo{Test-Driven Development — Qualität als Entscheidungsinstrument}{https://youtu.be/71nLhdZuMk0}
...
\ytvideo{DevOps-Operating-Model — „you build it, you run it” und Plattform-Teams}{https://youtu.be/ak3oE0I6cXU}
