...
\ytvideo{Was ist BPM-Software? — Repository und Engine in der Übersicht}{https://youtu.be/vL6VOjsCJSo}
...
\ytvideo{Camunda 8 — vom Modell zum laufenden Workflow}{https://youtu.be/rC_TdTOfdkE}
...
\begin{enumerate}
  ...
  \item Nach Freigabe wird im ERP (\emph{Enterprise Resource Planning}) gebucht und Zahlung angesto{\ss}en.
...
\ytvideo{Camunda DACH — Wie funktioniert Workflow Automation?}{https://youtu.be/M4UU2BXVc1g}
...
\ytvideo{Low-Code mit Camunda 8 — Prozessautomatisierung ohne Programmierung?}{https://youtu.be/33oG8WtRmdk}
...
\begin{enumerate}
  ...
  \item \textbf{Automation-Pipeline} (MVP = \emph{Minimum Viable Product} \textrightarrow{} Scale): Auswahlkriterien, Datenminimum, Exception-Policy, Monitoring / Audit Trail, KPI-Set (Leading / Lagging).
